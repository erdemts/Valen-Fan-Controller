...
#define	STX				0x02 //Start of text(command)
#define ETX				0x03 //End of Text(command)
...
#define UART_TRANSMIT_BUFFER_SIZE                     ( 30 )//Master Address, Slave Address, Command, DataSize, 8 Data, CRCH, CRCL. Total 14 Bytes per packet
#define UART_RECEIVE_BUFFER_SIZE                     ( 60 )//STX, Command, 8 Data, ETX. Total 10 Bytes per packet
