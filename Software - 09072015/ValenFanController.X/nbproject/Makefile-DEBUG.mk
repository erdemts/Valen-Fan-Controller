...
SOURCEFILES_QUOTED_IF_SPACED=../src/adc.c ../src/main.c ../src/uart.c ../src/vhn5019.c ../src/ds18b20.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1360937237/adc.p1 ${OBJECTDIR}/_ext/1360937237/main.p1 ${OBJECTDIR}/_ext/1360937237/uart.p1 ${OBJECTDIR}/_ext/1360937237/vhn5019.p1 ${OBJECTDIR}/_ext/1360937237/ds18b20.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1360937237/adc.p1.d ${OBJECTDIR}/_ext/1360937237/main.p1.d ${OBJECTDIR}/_ext/1360937237/uart.p1.d ${OBJECTDIR}/_ext/1360937237/vhn5019.p1.d ${OBJECTDIR}/_ext/1360937237/ds18b20.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1360937237/adc.p1 ${OBJECTDIR}/_ext/1360937237/main.p1 ${OBJECTDIR}/_ext/1360937237/uart.p1 ${OBJECTDIR}/_ext/1360937237/vhn5019.p1 ${OBJECTDIR}/_ext/1360937237/ds18b20.p1

# Source Files
SOURCEFILES=../src/adc.c ../src/main.c ../src/uart.c ../src/vhn5019.c ../src/ds18b20.c
...
${OBJECTDIR}/_ext/1360937237/ds18b20.p1: ../src/ds18b20.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1360937237" 
	${MP_CC} --pass1 ../src/ds18b20.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1360937237" -N31 -I"../src" -I"../include" --warn=0 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,-stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=default,+asm,-asmfile,-speed,+space,-debug,9 -D__DEBUG --debugger=realice  --double=24 --float=24 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: %s" "--msgformat=%f:%l: advisory: %s" "--warnformat=%f:%l warning: %s"
	@${MP_CC} --scandep  ../src/ds18b20.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1360937237" -N31 -I"../src" -I"../include" --warn=0 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,-stackcall,+clib --opt=default,+asm,-asmfile,-speed,+space,-debug,9 -D__DEBUG --debugger=realice  --double=24 --float=24 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: %s" "--msgformat=%f:%l: advisory: %s" "--warnformat=%f:%l warning: %s"
	@echo ${OBJECTDIR}/_ext/1360937237/ds18b20.p1: > ${OBJECTDIR}/_ext/1360937237/ds18b20.p1.d
	@cat ${OBJECTDIR}/_ext/1360937237/ds18b20.dep >> ${OBJECTDIR}/_ext/1360937237/ds18b20.p1.d
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/ds18b20.p1.d" $(SILENT) -ht  -rsi ${MP_CC_DIR}../ 
