...
__CONFIG(FOSC_HS & WDTE_ON & PWRTE_ON & MCLRE_OFF & CP_ON & CPD_ON & BOREN_ON & IESO_OFF & FCMEN_OFF & LVP_OFF & DEBUG_OFF & BOR4V_BOR40V );
...
//void putUartToTemp(char* isaret_adr, unsigned char* tam_adr, unsigned char* ondalik_adr)
//{
//    unsigned char i;
//    if(isaret)
//    {
...
//    }
//
//    dataConversionBuffer = *tam_adr;
//    if(dataConversionBuffer < 100)
//    {
//        putch('0');
//    }
//    itoa(tamBuf, dataConversionBuffer, 10);
//
//    dataConversionBuffer = *ondalik_adr;
//    itoa(ondalikBuf, dataConversionBuffer, 10);
//
//    i=0;
//    while(tamBuf[i] != '\0')
//    {
...
//        oneWireWriteByte(0x01);
//        oneWireWriteByte(0x02);
...
//        currentTemperature = oneWireReset();
//        oneWireWriteByte(0xCC);
...
//        debugModeStatus = EEPROM_READ(DEBUG_MODE_EEAddr);
//
...
//
//        runFanGroups();
//        if(EEPROM_READ(LCD_POWER_RELAY_EEaddr) == '1')
//        {
//            LCD_POWER_RELAY = 1;
//            LED_GREEN = 1;
//        }
...
//                {
//                    case CMD_SET_TEMP_LEVEL:
//                        vResetPrintBuffer();
//                        printBuffer[0] = dataBuffer[1];
//                        printBuffer[1] = dataBuffer[2];
//                        printBuffer[2] = dataBuffer[3];
//                        dataConversionBuffer = atoi(printBuffer);
//                        EEPROM_WRITE(TEMP_LEVEL_START_EEADDR + (dataBuffer[0] - 48) - 1, dataConversionBuffer);
//                        __delay_ms(5);
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_SET_TEMP_LEVEL);
//                        vAddToUartTransmitBuffer(dataBuffer[0]);    //Temp Level
//                        dataConversionBuffer = EEPROM_READ(TEMP_LEVEL_START_EEADDR + (dataBuffer[0] - 48) - 1);
//                        vResetPrintBuffer();
//                        itoa(printBuffer, dataConversionBuffer, 10);
//                        if(dataConversionBuffer == 0)
//                        {
//                            vAddToUartTransmitBuffer('0');
//                            vAddToUartTransmitBuffer('0');
//                            vAddToUartTransmitBuffer('0');
//                        }
//                        else if(dataConversionBuffer < 100)
//                        {
//                            vAddToUartTransmitBuffer('0');
...
//                        }
//                        vAddToUartTransmitBuffer(ETX);
//                        vCommandComplate();
//
//                        break;
//                    case CMD_GET_TEMP_LEVEL:
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_GET_TEMP_LEVEL);
//                        vAddToUartTransmitBuffer(dataBuffer[0]);    //Temp Level
//                        dataConversionBuffer = EEPROM_READ(TEMP_LEVEL_START_EEADDR + (dataBuffer[0] - 48) - 1);
//                        vResetPrintBuffer();
//                        itoa(printBuffer, dataConversionBuffer, 10);
...
//                        vCommandComplate();
//                        break;
//                    case CMD_SET_FAN_GROUP:
//                        dataConversionBuffer = 0;
//                        for(j=0; j<12; j++)
//                        {
//                            if(dataBuffer[j+1] == '1')
//                            {
//                                dataConversionBuffer <<= 1;
//                                dataConversionBuffer |= 0x0001;
//                            }
//                            else if(dataBuffer[j+1] == '0')
//                            {
//                                dataConversionBuffer <<= 1;
//                            }
//                        }
//                        EEPROM_WRITE(FAN_GROUP_START_EEADR_H + (dataBuffer[0] - 48)*2 - 2 , (dataConversionBuffer >> 6));
//                        __delay_ms(5);
//                        EEPROM_WRITE(FAN_GROUP_START_EEADR_H + (dataBuffer[0] - 48)*2 - 1 , (dataConversionBuffer & 0x003F));
//                        __delay_ms(5);
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_SET_FAN_GROUP);
//                        vAddToUartTransmitBuffer(dataBuffer[0]);
//                        dataConversionBuffer = 0;
//                        dataConversionBuffer = EEPROM_READ(FAN_GROUP_START_EEADR_H + (dataBuffer[0] - 48)*2 - 2 );
//                        dataConversionBuffer <<= 6;
//                        dataConversionBuffer |= (EEPROM_READ(FAN_GROUP_START_EEADR_H + (dataBuffer[0] - 48)*2 - 1 )) & 0x003F;
//                        for(j=0; j<12; j++)
//                        {
//                            dataBuffer[j+1] = ((dataConversionBuffer >> (11 - j)) & 0x0001) + 48;
//                            vAddToUartTransmitBuffer(dataBuffer[j+1]);
//                        }
//                        vAddToUartTransmitBuffer(ETX);
//                        vCommandComplate();
//                        break;
//                    case CMD_GET_FAN_GROUP:
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_GET_FAN_GROUP);
//                        vAddToUartTransmitBuffer(dataBuffer[0]);
//                        dataConversionBuffer = 0;
//                        dataConversionBuffer = EEPROM_READ(FAN_GROUP_START_EEADR_H + (dataBuffer[0] - 48)*2 - 2 );
//                        dataConversionBuffer <<= 6;
...
//                        vCommandComplate();
//                        break;
//                    case CMD_GET_CURRENT_TEMPERATURE:
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_GET_CURRENT_TEMPERATURE);
//                        dataConversionBuffer = currentTemperature;
//                        vResetPrintBuffer();
//                        itoa(printBuffer, dataConversionBuffer, 10);
//                        if(dataConversionBuffer == 0)
//                        {
...
//                        vCommandComplate();
//                        break;
//                    case CMD_LCD_POWER_ON:
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_LCD_POWER_ON);
//                        EEPROM_WRITE(LCD_POWER_RELAY_EEaddr, '1');
//                        __delay_ms(5);
//                        vAddToUartTransmitBuffer(EEPROM_READ(LCD_POWER_RELAY_EEaddr));
//                        vAddToUartTransmitBuffer(ETX);
//                        vCommandComplate();
//                        break;
//                    case CMD_LCD_POWER_OFF:
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_LCD_POWER_OFF);
//                        EEPROM_WRITE(LCD_POWER_RELAY_EEaddr, '0');
//                        __delay_ms(5);
//                        vAddToUartTransmitBuffer(EEPROM_READ(LCD_POWER_RELAY_EEaddr));
//                        vAddToUartTransmitBuffer(ETX);
//                        vCommandComplate();
//                        break;
//                    case CMD_GET_LCD_STATUS:
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_GET_LCD_STATUS);
//                        vAddToUartTransmitBuffer(EEPROM_READ(LCD_POWER_RELAY_EEaddr));
//                        vAddToUartTransmitBuffer(ETX);
//                        vCommandComplate();
//                        break;
//                    case CMD_GET_SERIAL_NO:
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_GET_SERIAL_NO);
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_0));
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_1));
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_2));
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_3));
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_4));
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_5));
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_6));
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_7));
//                        vAddToUartTransmitBuffer(ETX);
//                        vCommandComplate();
//                        break;
//                    case CMD_SET_SERIAL_NO:
//                        EEPROM_WRITE(DeviceSerial_EEAddr_0, dataBuffer[0]);
//                        __delay_ms(5);
//                        EEPROM_WRITE(DeviceSerial_EEAddr_1, dataBuffer[1]);
//                        __delay_ms(5);
//                        EEPROM_WRITE(DeviceSerial_EEAddr_2, dataBuffer[2]);
//                        __delay_ms(5);
//                        EEPROM_WRITE(DeviceSerial_EEAddr_3, dataBuffer[3]);
//                        __delay_ms(5);
//                        EEPROM_WRITE(DeviceSerial_EEAddr_4, dataBuffer[4]);
//                        __delay_ms(5);
//                        EEPROM_WRITE(DeviceSerial_EEAddr_5, dataBuffer[5]);
//                        __delay_ms(5);
//                        EEPROM_WRITE(DeviceSerial_EEAddr_6, dataBuffer[6]);
//                        __delay_ms(5);
//                        EEPROM_WRITE(DeviceSerial_EEAddr_7, dataBuffer[7]);
//                        __delay_ms(5);
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_SET_SERIAL_NO);
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_0));
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_1));
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_2));
//                        vAddToUartTransmitBuffer(EEPROM_READ(DeviceSerial_EEAddr_3));
...
//                        vCommandComplate();
//                        break;
//                    case CMD_SET_CURRENT_TEMPERATURE:
//                        if(debugModeStatus == '1')
//                        {
//                            vResetPrintBuffer();
//                            printBuffer[0] = dataBuffer[0];
//                            printBuffer[1] = dataBuffer[1];
//                            printBuffer[2] = dataBuffer[2];
//                            currentTemperature = atoi(printBuffer);
//
//                            vAddToUartTransmitBuffer(STX);
//                            vAddToUartTransmitBuffer(RSP_GET_CURRENT_TEMPERATURE);
//                            dataConversionBuffer = currentTemperature;
...
//                        vAddToUartTransmitBuffer(STX);
//                        vAddToUartTransmitBuffer(RSP_SET_DEBUG_MODE);
//                        EEPROM_WRITE(DEBUG_MODE_EEAddr, dataBuffer[0]);
//                        __delay_ms(5);
//                        vAddToUartTransmitBuffer(EEPROM_READ(DEBUG_MODE_EEAddr));
//                        vAddToUartTransmitBuffer(ETX);
//                        vCommandComplate();
//                        break;
//                    default:
